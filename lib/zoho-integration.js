...
class ZohoIntegration {
  ...
  formatTicketData(funnelData) {
    ...
    return {
      ...
      customFields: { ...baseCustomFields, ...specificCustomFields, ...partnerScoringFields, ...kalkulatorScoringFields, ...planerScoringFields, ...genehmigungScoringFields, ...bauzeitScoringFields },
      tags: [
        'balkonfuchs',
        funnel.type,
