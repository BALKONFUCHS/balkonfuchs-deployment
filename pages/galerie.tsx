...
import { Image, Camera, Clock, ArrowRight, Menu } from 'lucide-react';
import ZohoSalesIQ from '../components/ZohoSalesIQ.js';

export default function GalerieComingSoon() {
  ...
  return (
    <>
      <Head>
        <title>Balkon-Galerie - In Kürze verfügbar | BALKONFUCHS</title>
        <meta name="description" content="Unsere Balkon-Referenzgalerie wird aktuell erweitert und steht Ihnen in Kürze mit vielen inspirierenden Projekten zur Verfügung." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://balkonfuchs.de/galerie/" />
      </Head>
        ...
        <main className="py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full mb-6 border border-purple-500/30">
              ...
              <div className="inline-block bg-orange-500/10 border border-orange-500/30 px-4 py-2 rounded-full mb-6">
                <div className="flex items-center gap-2 text-orange-400">
                  ...
                  <span className="font-semibold">Wird vorbereitet</span>
                </div>
              </div>
              
              <p className="text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto mb-8">
                Wir bereiten aktuell eine umfangreiche <span className="text-orange-400 font-semibold">Referenzgalerie</span> mit 
                inspirierenden Balkon-Projekten für Sie vor. Die Galerie wird in den kommenden Wochen mit vielen 
                Beispielen aus ganz Deutschland verfügbar sein.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Demnächst online</h3>
                    <p className="text-gray-400 leading-relaxed">
                      Die Balkon-Galerie wird in den nächsten Wochen mit hunderten inspirierenden Referenzprojekten online gehen.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Umfangreiche Sammlung</h3>
                    <p className="text-gray-400 leading-relaxed">
                      Verschiedene Balkontypen, Geländervarianten und Materialien aus allen Regionen Deutschlands.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-2xl p-8 mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-6">
                ...
                <a href="/erfahrungen/" className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 hover:border-orange-500/50 transition-all group">
                  ...
                  <p className="text-gray-400 text-sm">
                    Echte Bewertungen lesen
                  </p>
                  <div className="mt-4 flex items-center text-orange-400 text-sm font-medium">
                    Erfahrungen lesen <ArrowRight className="w-4 h-4 ml-1" />
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-8 text-center">
              ...
              <p className="text-gray-400 mb-6">
                Chatten Sie direkt mit uns – wir informieren Sie gerne über den Launch der Galerie!
              </p>
              <button 
                onClick={() => {
