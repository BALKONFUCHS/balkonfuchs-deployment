  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://balkonfuchs.de/partner-info" />
        <link rel="canonical" href="https://balkonfuchs.de/partner-info" />
      </Head>
        ...
        <main className="py-16 bg-gray-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-16">
              ...
              {/* Erfolgs-Leitfaden Section */}
              <section className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border-2 border-orange-500/30 rounded-2xl p-8 mb-16">
                <h2 className="text-3xl font-bold text-white mb-6 text-center flex items-center justify-center">
                  ...
                  Erfolgs-Leitfaden für Berlin-Partner
                </h2>
                
                <div className="max-w-4xl mx-auto">
                  <p className="text-xl text-gray-300 text-center mb-8 leading-relaxed">
                    <strong className="text-orange-400">Kostenloser Download:</strong> Unser 8-seitiger Erfolgs-Leitfaden 
                    mit detaillierten ROI-Berechnungen, Strategien und Best Practices für Berlin-Partner.
                  </p>
                  
                  <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-gray-800/50 rounded-xl p-6 text-center border border-orange-500/30">
                      <div className="text-3xl font-bold text-orange-400 mb-2">5,2x</div>
                      <div className="text-gray-300 mb-2">ROI Starter-Paket</div>
                      <div className="text-sm text-gray-400">599€/M • 8 Leads</div>
                    </div>
                    <div className="bg-gray-800/50 rounded-xl p-6 text-center border border-orange-500/30">
                      <div className="text-3xl font-bold text-orange-400 mb-2">6,8x</div>
                      <div className="text-gray-300 mb-2">ROI Professional-Paket</div>
                      <div className="text-sm text-gray-400">1.199€/M • 15 Leads</div>
                    </div>
                    <div className="bg-gray-800/50 rounded-xl p-6 text-center border border-orange-500/30">
                      <div className="text-3xl font-bold text-orange-400 mb-2">7,3x</div>
                      <div className="text-gray-300 mb-2">ROI Enterprise-Paket</div>
                      <div className="text-sm text-gray-400">2.199€/M • 30 Leads</div>
                    </div>
                  </div>
                  
                  <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/40 rounded-xl p-6 text-center">
                    <h3 className="text-xl font-bold text-white mb-4">📊 Was Sie im Leitfaden finden:</h3>
                    <div className="grid md:grid-cols-2 gap-4 text-gray-300">
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-400" />
                          <span>Detaillierte ROI-Berechnungen</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-400" />
                        ...
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-400" />
                          <span>Lead-Qualifizierung</span>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-400" />
                          <span>Berlin-Marktanalyse</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-400" />
                          <span>Best Practice Beispiele</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="w-5 h-5 text-green-400" />
                          <span>Skalierungsstrategien</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-center mt-8">
                    <a 
                      href="/erfolgs-leitfaden-preview" 
                      className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-lg font-bold text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                    >
                      <span className="text-2xl">📖</span>
                      Erfolgs-Leitfaden kostenlos herunterladen
                    </a>
                    <p className="text-gray-400 text-sm mt-3">
                      8 Seiten • PDF-Format • Sofort verfügbar
                    </p>
                  </div>
                </div>
              </section>
